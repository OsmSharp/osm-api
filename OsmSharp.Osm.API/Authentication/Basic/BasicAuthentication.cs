...
// original: https://github.com/NancyFx/Nancy/blob/master/src/Nancy.Authentication.Basic/BasicAuthentication.cs
  ...
  /// </summary>
    public static class BasicAuthentication
    {
        ...
        private static void RetrieveCredentials(NancyContext context, BasicAuthenticationConfiguration configuration)
        {
            ...
            {
                var user = configuration.UserValidator(credentials[0], credentials[1], context);
        ...
        private static string[] ExtractCredentialsFromHeaders(this Request request)
        {
            var authorization =
        ...
        {
            return configuration.UserPromptBehaviour == UserPromptBehaviour.Always || 
                (configuration.UserPromptBehaviour == UserPromptBehaviour.NonAjax && !context.Request.IsAjaxRequest());
        }
    }
}
